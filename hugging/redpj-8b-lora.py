...
VER = f'{MODEL_VARIANT}-8bit-lora-{RANDOM_SEED}'
...
ending = """
Does the above document relate to interventions involving transportation intended to have some desirable impact, such
as improving health or safety, reducing transit times, encouraging use of public transporation, providing economic
benefits, etc? Answer only 'yes' or 'no'.\n\nAnswer: 
"""
